...
public class Chart extends JFrame {
    ...
    class MyCanvas extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            for (int i=0;i<points.size();i++){
                System.out.println(new Double(points.get(i).getX()).intValue()+"===="+new Double(points.get(i).getY()).intValue());

                g.drawString("·",new Double(points.get(i).getX()).intValue(),new Double(points.get(i).getY()).intValue());
    ...
    private static void initPointsCircular() {
