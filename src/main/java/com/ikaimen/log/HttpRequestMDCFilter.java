 ...
 * @Author Norman
 * @Date 2019/6/18 3:18 PM
 * @ModifyDate 2019/6/18 3:18 PM
 * @Param
 * @Return
 * @Version 1
 */
public class HttpRequestMDCFilter implements Filter {
    ...
    private void mdc(HttpServletRequest hsr) {
        ...
        String requestId = hsr.getHeader(MDCConstants.REQUEST_ID_HEADER);
        if(!StringUtils.isEmpty(requestId)){
            MDC.put(MDCConstants.REQUEST_ID_MDC_KEY, hsr.getHeader(MDCConstants.REQUEST_ID_HEADER));
        }
        MDC.put(MDCConstants.REQUEST_ID_MDC_KEY, UUID.randomUUID().toString()+System.currentTimeMillis());
